...
Revision ID: a9f82e682e14
Revises: d8dfdb4a4b82
Create Date: 2025-07-28 20:41:34.657542
...
revision = 'a9f82e682e14'
down_revision = 'd8dfdb4a4b82'
branch_labels = None
depends_on = None
...
def upgrade_ZLTGSQOZ566UATSNRB2Y5JTWOA():
    ...
    sa.Column('first_name', sa.String(length=255), autoincrement=False, nullable=False),
    sa.Column('last_name', sa.String(length=255), autoincrement=False, nullable=False),
    sa.Column('full_name', sa.String(length=511), autoincrement=False, nullable=True),
    sa.Column('function', sa.String(length=255), autoincrement=False, nullable=True),
    ...
    sa.Column('mobile', sa.String(length=20), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['company'], ['companies.id'], name='fk_contacts_companies_company', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['workspace'], ['workspaces.id'], name='fk_contacts_workspaces_workspace', onupdate='CASCADE', ondelete='CASCADE'),
