...
Revision ID: f56b5ebac316
Revises: ba01c4eed0cf
Create Date: 2025-07-28 18:39:58.873530
...
revision = 'f56b5ebac316'
down_revision = 'ba01c4eed0cf'
branch_labels = None
depends_on = None
...
def upgrade_ZLTGSQOZ566UATSNRB2Y5JTWOA():
    ...
    op.create_table('job_specialities',
    ...
    sa.ForeignKeyConstraint(['workspace'], ['workspaces.id'], name='fk_job_specialities_workspaces_workspace', onupdate='CASCADE', ondelete='CASCADE'),
...
def downgrade_ZLTGSQOZ566UATSNRB2Y5JTWOA():
    ...
    # main database
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('job_specialities')
    # ### end Alembic commands ###
